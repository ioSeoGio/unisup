...
use domain\workReports\WorkReportType;

/**
 * Handles the creation of table `{{%work_report_types}}`.
 */
class m220511_174814_create_work_report_types_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert('{{%work_report_types}}', ['serial_number', 'type', 'description', 'foreign_points', 'belarus_points', 'brest_points'], [
            ...
            [1, WorkReportType::IDEOLOGICAL, 'Распрацоўка лакальнага прававога акта па ІВП, зацверджанага ва ўстаноўленым парадку (на ўсіх распрацоўшчыкаў)', null, null, 7],
            [6, WorkReportType::IDEOLOGICAL, "Кіраўніцтва (без аплаты) студэнцкім пастаянна дзеючым калектывам, аб'яднаннем: добраахвотніцкія атрады, групы; клубы па інтарэсах; краязнаўчая група, творчы калектыў, зборнай камандай і інш. (пры наяўнасці загада, распараджэння і вынікаў працы", null, null, 4],
        ]);
    }
